...
public class _02_IFramelerGecis extends BaseDriver {
    ...
    public void Test1()
    {
        ...
        //driver.switchTo().parentFrame();  // 1 kademe icerde oldugumdan yine default page e ulasiyor.
        driver.switchTo().defaultContent(); // defaul page yani asil giris sayfasina ulastim, ayni sekilde

        //driver.switchTo().defaultContent().switchTo().frame(1);  // bu sekilde direk de kullanilabilir 2 gecis birlestirildi
        driver.switchTo().frame(1);  // ana sayfadaki 2.frame(index olarak 1) ulasildi. Burasi select in oldugu yer
